...
export declare class Target {
     ...
     * @internal
     */
    _initializedPromise: import("../util/DeferredPromise.js").DeferredPromise<InitializationStatus>;
    /**
     * @internal
     */
    _isClosedPromise: import("../util/DeferredPromise.js").DeferredPromise<void>;
    /**
     * @internal
     */
    _targetId: string;
