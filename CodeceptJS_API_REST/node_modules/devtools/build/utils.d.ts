 ...
 */
export declare function patchDebug(scoppedLogger: Logger): Promise<void>;
export declare const sleep: (time?: number) => Promise<unknown>;
export declare const launchChromeUsingWhich: (err: Error, launchOptions: Options) => Promise<import("chrome-launcher").LaunchedChrome>;
