...
class Target {
    ...
    constructor(targetInfo, session, browserContext, targetManager, sessionFactory) {
         ...
         * @internal
         */
        this._initializedPromise = (0, DeferredPromise_js_1.createDeferredPromise)();
        /**
         * @internal
         */
        this._isClosedPromise = (0, DeferredPromise_js_1.createDeferredPromise)();
...
class PageTarget extends Target {
    ...
    constructor(targetInfo, session, browserContext, targetManager, sessionFactory, ignoreHTTPSErrors, defaultViewport, screenshotTaskQueue) {
        ...
        __classPrivateFieldSet(this, _PageTarget_defaultViewport, defaultViewport !== null && defaultViewport !== void 0 ? defaultViewport : undefined, "f");
    ...
    async page() {
        ...
        if (!this.pagePromise) {
            ...
            this.pagePromise = (session
                ...
                var _a;
                return Page_js_1.CDPPage._create(client, this, __classPrivateFieldGet(this, _PageTarget_ignoreHTTPSErrors, "f"), (_a = __classPrivateFieldGet(this, _PageTarget_defaultViewport, "f")) !== null && _a !== void 0 ? _a : null, __classPrivateFieldGet(this, _PageTarget_screenshotTaskQueue, "f"));
            });
        }
