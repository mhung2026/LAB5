...
export class Target {
    ...
    constructor(targetInfo, session, browserContext, targetManager, sessionFactory) {
         ...
         * @internal
         */
        this._initializedPromise = createDeferredPromise();
        /**
         * @internal
         */
        this._isClosedPromise = createDeferredPromise();
    ...
    async page() {
        ...
        if (!this.pagePromise) {
            ...
            this.pagePromise = (session
                ...
                var _a;
                return CDPPage._create(client, this, __classPrivateFieldGet(this, _PageTarget_ignoreHTTPSErrors, "f"), (_a = __classPrivateFieldGet(this, _PageTarget_defaultViewport, "f")) !== null && _a !== void 0 ? _a : null, __classPrivateFieldGet(this, _PageTarget_screenshotTaskQueue, "f"));
            });
        }
