 ...
 */
export async function patchDebug(scoppedLogger) {
    /**
...
export const launchChromeUsingWhich = async (err, launchOptions) => {
    /**
    ...
    const chromePath = await which('chrome')
        .catch((errorChrome) => which('chromium')
        .catch((errorChromium) => which('google-chrome')
        .catch((errorGoogleChrome) => {
        throw new Error(util.format(errorMessage, errorChrome.message, errorChromium.message, errorGoogleChrome.message));
    })));
